...
public:
	...
	constexpr Vec_<N,T> to_Vec() const { return Vec_<N,T>(r,g); }
...
public:
	...
	constexpr Vec_<N,T> to_Vec() const { return Vec_<N,T>(r,g,b); }
...
//---
	...
	constexpr Vec_<N,T> to_Vec() const { return Vec_<N,T>(r,g,b,a); }
