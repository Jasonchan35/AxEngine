...
export module AxPlatform.SpinLock;

export import AxPlatform.BasicType;
export import AxPlatform.ScopedLock;
export import AxPlatform.LockProtected;
export import AxPlatform.ThreadUtil; 
export import AxPlatform.TimeDuration;
